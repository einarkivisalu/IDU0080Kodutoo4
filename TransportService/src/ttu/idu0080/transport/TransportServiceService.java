...
public class TransportServiceService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/Random/workspace4test2/TransportService/src/transport.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(TransportServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/Random/workspace4test2/TransportService/src/transport.wsdl");
        }
        WSDL_LOCATION = url;
    }
