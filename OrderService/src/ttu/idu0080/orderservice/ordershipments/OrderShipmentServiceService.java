...
public class OrderShipmentServiceService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/Random/workspace4test2/OrderService/src/order_shipments.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(OrderShipmentServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/Random/workspace4test2/OrderService/src/order_shipments.wsdl");
        }
        WSDL_LOCATION = url;
    }
