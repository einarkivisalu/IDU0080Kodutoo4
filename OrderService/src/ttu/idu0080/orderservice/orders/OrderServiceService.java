...
public class OrderServiceService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/Random/workspace4test2/OrderService/src/orders.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(OrderServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/Random/workspace4test2/OrderService/src/orders.wsdl");
        }
        WSDL_LOCATION = url;
    }
